...
```html
<img src="https://cdn.devimage.cn/avatar/devimg/张三/128" />
<img src="https://cdn.devimage.cn/avatar/lorelei/user-1/64" />
<img src="https://cdn.devimage.cn/avatar/devimg-matrix/demo/128" />
```
...
| 3 | 字母/中文头像 | `GET /avatar/:style/:seed/:size`（59 风格） | ✅ 告一段落 |
...
| 12 | picsum 兼容开关 | 环境变量 |
| 13 | 码形占位 | `/qr/:seed/:size`、`/barcode/:seed/:w/:h`（伪，不可扫） |
...
├── avatar/          ✅ 一期  /avatar/（59 风格，暂不再扩展）
├── code/            ✅ Phase 2.5–3  /qr/ · /barcode/ · /code/styles
├── scene/           ✅ 一期  /scene/, /404
├── mock/            ✅ 一期+ /mock/*
├── photo/           📋 二期  /photo/, /id/
├── common/          ✅ 校验工具
